...
public class TubeEasy_Screens {
    ...
    private static  int TUBE_GAP = 150;  //  this will be the gap between 2 tubes
    private static final  int LOWEST_OPENING = 100 ; // where from the bottom of the screen should can we have top tube
    ...
    public TubeEasy_Screens(float x, BriskyBird game){
