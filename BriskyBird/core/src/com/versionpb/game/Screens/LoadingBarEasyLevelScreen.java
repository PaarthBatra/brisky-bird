...
public class LoadingBarEasyLevelScreen implements Screen {
    ...
    public LoadingBarEasyLevelScreen(final BriskyBird game){
        this.game = game;
        ...
        labelLoading = new Label(GameInfo.loadingEasyScreenLabelText,skin,GameInfo.loadingLabelStyleName);
        ...
        game.myassetManager.loadEasyLevelTextures();
        game.myassetManager.loadEasyMusic();
        game.myassetManager.loadGameOverImages();
        game.myassetManager.loadEasyLevelFonts();
    ...
    public void render(float delta) {
        ...
        if(game.myassetManager.manager.update()){
            ...
            game.setScreen(new PlayEasyLevelScreen(game));
